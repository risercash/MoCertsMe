# Generated by Django 3.2.5 on 2021-09-26 05:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.URLField(default='http://127.0.0.1:8000/media/preview.jpg', help_text='Данное поле для всех страниц. Для сертификатов подставляется своя картинка', max_length=255, verbose_name='Ссылка на картинку')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(blank=True, default=0, max_length=12, verbose_name='phone number')),
                ('address', models.CharField(blank=True, default=0, max_length=255, verbose_name='address')),
